      ...
      <Box fill direction="column">
        ...
        >
          ...
          <Box gap="medium">
            ...
            <Box
              ...
              justify="center"
              pad="small"
              className={styles.introImageBox}
            >
              <Image
                fill="horizontal"
        ...
        >
          ...
          <div className={styles.solutionGrid}>
            <Text className={`${styles.solutionText} ${styles.text1}`} color={textColor}>
            ...
            <Box
              ...
              justify="center"
              pad="small"
              className={styles.bImageBox}
            >
              <Image width="100%" src="images/gametheory/b.png"></Image>
            </Box>
            <Box className={`${styles.solutionText} ${styles.text2}`} margin={{ top: "30px", bottom: "30px" }}>
            ...
            <Box
              ...
              justify="center"
              pad="small"
              className={styles.aImageBox}
            >
              <Image width="100%" src="images/gametheory/aprob.png"></Image>
            </Box>
            <Text className={`${styles.solutionText} ${styles.text3}`} color={textColor}>
